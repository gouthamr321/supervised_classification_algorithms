...
rm(list = ls())
setwd("/Users/goutham/Development/statistical_data_mining/comp_labs/KNN")
...
######################################################
#  Create a test data set .... This is basically a test set for KNN visualization
...
knnplot <- function(train, test, k){ # function in R
